...
const MenuPage = () => {
  ...
  const items = [
    ...
    { id: 2, name: 'Шок. молоко', price: '820', description: 'Освежающий и сладкий напиток, приготовленный из холодного молока и шоколадного сиропа или какао. Идеально подходит для любителей шоколада.', img: chocolatemilk1 },
    ...
    { id: 12, name: 'Шок. фондан', price: '1100', description: 'Нежное пирожное с хрустящей корочкой и мягкой, слегка жидкой начинкой из темного шоколада, которое тает во рту, наполняя каждый кусочек насыщенным и глубоким вкусом. Подается горячим, чтобы вы могли ощутить всю прелесть текучего шоколадного сердца.', img: fondan },
  ];
